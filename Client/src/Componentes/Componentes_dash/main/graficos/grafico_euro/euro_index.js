...
function Euro() {
  ...
  return (
    ...
    <h5 className="texto-euro">Mais Informações</h5>
    <span class="tooltiptext-euro">Euro é a moeda oficial da zona Euro, a qual é constituída por 19 dos 27 estados-membro da União Europeia: 
